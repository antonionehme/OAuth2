...
<title>Ministry of Interior Affairs</title>
...
<body>
	...
	<div class="container">
		<h1>Ministry of Interior Affairs</h1>
		...
		<authz:authorize ifAllGranted="ROLE_USER">
			...
			<p>
				You hereby authorize The Ministry of transport
			...
			<form id="confirmationForm" name="confirmationForm"
				...
				<input type="radio" name="true"
									...
									name="false" value="false">Deny</input>
									<br /><br />
